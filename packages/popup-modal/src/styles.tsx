...
export const GlobalStyle = createGlobalStyle`
  :root {
	...
	@font-face {
		...
		src: url(${browser.runtime.getURL('/fonts/KumbhSans-Bold.ttf')});
		font-style: normal;
		font-weight: 600;
	}
	...
	@font-face {
		font-family: 'Kumbh Sans';
		src: url(${browser.runtime.getURL('/fonts/KumbhSans-Regular.ttf')});
		font-style: normal;
		font-weight: 400;
	}
...
export const SearchedTab = styled.div<{
  isSelected?: boolean;
  ...
  padding: 0 0.3rem;
  background: ${(props) =>
    props.isSelected ? 'var(--input-primary-light)' : 'auto'};
  user-select: none;
  border-radius: 4px;
  overflow: hidden;
  cursor: pointer;
